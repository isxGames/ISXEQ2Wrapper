...
namespace EQ2.ISXEQ2
{
	public class EQ2Event
	{
		...
		public event System.EventHandler<LSEventArgs> LootWindowAppeared;
		...
		{
			System.EventHandler<LSEventArgs> temp = LootWindowAppeared;
			if (temp != null)
				temp(Sender, e);
		}
		...
		~EQ2Event()
		{
			...
			LavishScript.Events.DetachEventTarget(LavishScript.Events.RegisterEvent("EQ2_onLootWindowAppeared"), OnLootWindowAppeared);
		...
		public EQ2Event()
		{
			...
			LavishScript.Events.AttachEventTarget(LavishScript.Events.RegisterEvent("EQ2_onLootWindowAppeared"), OnLootWindowAppeared);
